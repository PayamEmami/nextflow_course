...
```{bash, attr.source='.numberLines',eval=FALSE}
'/crex/proj/uppmax2022-2-10/metabolomics/mzMLData/*.mzML' )
process featureFinder {
echo true
input:
file x from mzMLFiles
...
```{bash, attr.source='.numberLines',eval=FALSE}
nextflow main_19.nf -c nextflow_19.config --project "uppmax2022-2-10" --clusterOptions "-M snowy" 
```
...
Create a file called `main_20.nf`
...
Create a file called `main_21.nf`
...
Create a file called `main_22.nf`
...
```{bash, attr.source='.numberLines',eval=FALSE, class.source="nohide"}
nextflow main_22.nf --inputmzml "/crex/proj/uppmax2022-2-10/metabolomics/mzMLData/*.mzML"
```
...
Create a file called `main_23.nf`
...
```{bash, attr.source='.numberLines',eval=FALSE, class.source="nohide"}
nextflow main_23.nf --inputmzml "/crex/proj/uppmax2022-2-10/metabolomics/mzMLData/*.mzML" --qc 100
```
